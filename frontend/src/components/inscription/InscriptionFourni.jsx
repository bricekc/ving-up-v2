...
import { postFournisseur } from "../../services/api/user/user";
import { Link } from "wouter";

function InscriptionFourni() {
    ...
    const submitForm = (event) => {
        ...
        const data = {"email": email, "password": password, "lastname": lastname, "firstname": firstname, "ville": ville, "cp": cp, "adresse": adresse};
        postFournisseur(data);
    }

    return (
        <>
        <h1 className="class_user">Inscription Fournisseur</h1>
        <Link href="/inscription/viticulteur"><button className="user_button_submit">Vous êtes un Viticulteur ?</button></Link>
...
export default InscriptionFourni;