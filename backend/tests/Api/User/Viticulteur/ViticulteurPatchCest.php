...
class ViticulteurPatchCest
{
    ...
    public function viticulteurCanPatchHisDataAndHisPassword(ApiTester $I)
    {
        ...
        $I->sendPatch('/api/viticulteurs/1', $data);
    ...
    public function UserCannotPatchAnOtherViticulteur(ApiTester $I)
    {
        $user = ViticulteurFactory::createOne();
        $I->amLoggedInAs($user->object());
        ...
        $I->sendPatch('/api/viticulteurs/2', $data);
        $I->seeResponseCodeIs(HttpCode::FORBIDDEN);
    }

    public function anonymousUserCannotPatchAViticulteur(ApiTester $I)
    {
        $data = [
            'email' => 'piodoru@example.com',
            'password' => 'test01',
