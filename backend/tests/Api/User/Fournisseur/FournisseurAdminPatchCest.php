...
class FournisseurAdminPatchCest
{
    ...
    public function AdminCanPatchVerificationOfFournisseur(ApiTester $I)
    {
        ...
        $I->sendPatch('/api/fournisseur/verif/2', $data);
    ...
    public function NonAdminUserCannotPatchVerificationOfFournisseur(ApiTester $I)
    {
        ...
        $I->sendPatch('/api/fournisseur/verif/1', $data);
