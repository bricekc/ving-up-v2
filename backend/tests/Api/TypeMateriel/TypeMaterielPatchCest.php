...
class TypeMaterielPatchCest
{
    public function anonymousUserCantPatchTypeMateriel(ApiTester $I): void
    {
        // 1. 'Arrange'
        ...
        // 2. 'Act'
        $I->sendPatch('/api/type_materiels/'.$TypeMateriel->getId(), [
    ...
    public function otherAutenticatedFournisseurCantPatchTypeMateriel(ApiTester $I): void
    {
        // 1. 'Arrange'
        $tag = TagFactory::createOne([
            'nom' => 'tagTest',
    ...
    public function authenticatedViticulteurCantPatchTypeMateriel(ApiTester $I): void
    {
        // 1. 'Arrange'
        $tag = TagFactory::createOne([
            'nom' => 'tagTest',
    ...
    public function authenticatedAdminCanPatchTypeMateriel(ApiTester $I): void
    {
        // 1. 'Arrange'
        $tag = TagFactory::createOne([
            'nom' => 'tagTest',
    ...
    public function authenticatedFournisseurCanPatchTypeMateriel(ApiTester $I): void
    {
        // 1. 'Arrange'
        $tag = TagFactory::createOne([
            'nom' => 'tagTest',
